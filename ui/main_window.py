...
class AutoClipWardogsApp(ctk.CTk):
    def __init__(self):
        ...
        self._setup_ui(); self.protocol("WM_DELETE_WINDOW", self._on_close)
    ...
    def _execute_batch(self, out_dir, mode_choice, group_multikills=True):
        ...
        def task():
            ...
            # Si se elige agrupar por conjunto de bajas (Multikill unificado)
            if group_multikills:
                clusters = []
                current_cluster = []
                ...
                # Exportar bajas individuales una a una
